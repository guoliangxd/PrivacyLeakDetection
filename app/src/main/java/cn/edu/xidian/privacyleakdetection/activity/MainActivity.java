...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button permisson = (Button )findViewById(R.id.permisson);
        Button data = (Button) findViewById(R.id.data);
        Button comprehensive = (Button ) findViewById(R.id.comprehensive);
        //给三个按钮分别设定监听器
        ...
        data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this,"数据分析功能正在开发中，敬请期待！",Toast.LENGTH_SHORT).show();
        ...
        comprehensive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this,"综合分析功能正在开发中，敬请期待！",Toast.LENGTH_SHORT).show();
